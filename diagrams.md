...
classDiagram
    ...
    class Innings {
        +String _id
        +Object team{batting_team, bowling_team}
        +Number runs
        +Number wickets
        +Array~Over~ overs
        +Object extras{wides, no_balls, byes, leg_byes}
    ...
    class Ball {
        +Number ball_number
        +Object batsman{_id, playerName}
        +Object bowler{_id, playerName}
        +Number runs
        +Object wicket{fallen, wicketType, fielder}
        +Object extras{wides, no_balls, byes, leg_byes}
    }
